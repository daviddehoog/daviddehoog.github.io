...
*2024-09-24*: First, I set up a static \[about page\](({{\< ref "/about/" >}})), with a bit about me. I also added a link to the header on each other page.

*2024-10-20*: Second, I set up a taxonomy of post topics, which allows me to add topic tags to each post and provides a \[list of all posts on a topic\]({{\< ref "/topics" >}}).
