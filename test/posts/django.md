...
Similiarly, having to wrestle with local database storage of an open dataset every time a new version was released (with new rows *and* updates to existing rows) helped me see what a data pipeline was about.
